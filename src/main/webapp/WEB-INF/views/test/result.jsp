...
<body>
	...
	<div class="container mt-5 mb-5 font-nanum" style="min-height: 100%;">
		...
		<div align="center">
			...
			<button onclick="location.href='<c:url value='/post/list/${type}'/>'"  class="bttn-stretch bttn-lg bttn-success mt-3">${type}게시글 보기</button>
			<button onclick="location.href='<c:url value='/map/${category}'/>'"  class="bttn-stretch bttn-lg bttn-success mt-3">${category} 병원 찾아보기</button>
		</div>
	</div>
